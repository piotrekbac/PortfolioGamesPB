...
using System.IO;    // Dodane dla obsługi plików
...
namespace ConsoleGames.Games
{
    ...
    public class SnakeGame
    {
        ...
        private const int WinningScore = 250;                               // Próg punktowy do osiągnięcia zwycięstwa
        ...
        private void ShowStartScreen()
        {
            ...
            DrawCenteredText(" Sterowanie: Strzałki ", centerY + 4, ConsoleColor.Gray);                     // Rysuję instrukcję sterowania grą
            ...
            DrawCenteredText(" o - Tułów węża ", centerY + 9, ConsoleColor.DarkGreen);                            // Rysuję legendę dla tułowia węża
        ...
        private void ShowGameOverScreen(bool won, bool newRecord)
        {
            ...
            string scoreText = $"Twój wynik: {score} pkt";                                // Tekst z wynikiem gracza
        ...
        private void DrawBorder()
        {
            ...
            // Rysowanie górnej linii z rogami: ╔══════╗
